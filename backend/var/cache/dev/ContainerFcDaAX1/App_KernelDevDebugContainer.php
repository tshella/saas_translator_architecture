...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getDoctrine_Dbal_DefaultConnectionService($container)
    {
        ...
        $b->pushHandler(($container->privates['monolog.handler.deprecation'] ?? self::getMonolog_Handler_DeprecationService($container)));
    ...
    /**
     * Gets the private 'monolog.formatter.line' shared autowired service.
     *
     * @return \Monolog\Formatter\LineFormatter
     */
    protected static function getMonolog_Formatter_LineService($container)
    {
        return $container->privates['monolog.formatter.line'] = new \Monolog\Formatter\LineFormatter('[%datetime%] %channel%.%level_name%: %message% %context%\\n', 'Y-m-d H:i:s');
    }
    ...
    protected static function getMonolog_Handler_ConsoleService($container)
    {
        ...
        $instance->setFormatter(($container->privates['monolog.formatter.line'] ?? self::getMonolog_Formatter_LineService($container)));
    ...
    {
        $container->privates['monolog.handler.deprecation'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/deprecations.log'), 'notice', true, NULL, false);
    ...
    protected static function getMonolog_Handler_MainService($container)
    {
        ...
        $instance->pushProcessor(($container->privates['monolog.processor.psr_log_message'] ??= new \Monolog\Processor\PsrLogMessageProcessor()));
        $instance->setFormatter(new \Monolog\Formatter\JsonFormatter(2, true));
