...
class getMessenger_DefaultBusService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['messenger.default_bus'] = new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            ...
            yield 6 => ($container->privates['messenger.bus.default.middleware.doctrine_transaction'] ?? $container->load('getMessenger_Bus_Default_Middleware_DoctrineTransactionService'));
            yield 7 => ($container->privates['App\\Middleware\\TranslationLoggingMiddleware'] ?? $container->load('getTranslationLoggingMiddlewareService'));
            yield 8 => ($container->privates['messenger.bus.default.middleware.send_message'] ?? $container->load('getMessenger_Bus_Default_Middleware_SendMessageService'));
            yield 9 => ($container->privates['messenger.bus.default.middleware.handle_message'] ?? $container->load('getMessenger_Bus_Default_Middleware_HandleMessageService'));
        }, 10));
    }
}
